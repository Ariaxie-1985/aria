...
from api_script.education.course import get_course_commentList, get_distribution_poster_data, get_credit_center_info, \
    get_distribution_course_list, get_my_earing, get_user_earnings_detail, receive_credit, exchange_present
...
def test_is_verify_code_reach_upper_limit():
    ...
    assert_not_equal(-1, send_verify_code_times, '获取验证码用例通过', te='杨彦')
