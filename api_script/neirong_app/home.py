...
def deliver_rec(userToken, ip_port=None):
...
def fast_feedback(userToken, ip_port=None):
...
def home_headline(userToken, ip_port=None):
...
def home_page(userToken, ip_port=None):
...
def searchBySalary(userToken, ip_port=None):
