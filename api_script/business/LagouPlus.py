...
def lagouPlus():
    ...
    data = {"templateId": 1, "num": 1, "companyId": 142136, "contractNo": "LG-HD-WANGXIA-2019030401",
            "userId": 100014641, "startTimeStr": "2019-01-07", "endTimeStr": "2020-01-10", "upgrade": "false"}
    object = form_post(url=contractnumurl, remark="新增免费合同", data=data, headers=header)
    print(object)
    treatycontents = get_requests(
        url="https://home.lagou.com/crm/olddata/queryByCsv.json?userId=84&pageIndex=0&pageSize=100&sortField=&sortOrder=&_=1546593382369",
        headers=header, remark="获取合同内容")
    ...
    print('????')
    assert_equal("50.050.050.014.0", str(TotalNum) + str(Pluspower) + str(PostsnNumber) + str(users),
                 "对比套餐内容，所得内容正确免费版", "对比套餐内容，所得内容不匹配")
...
def lagouPlusqiu():
    ...
    '''
    contractnumurl = "https://home.lagou.com/crm/valueadded/product/open.json"
    data = {"templateId": 5, "num": 1, "companyId": 14, "contractNo": "LG-HD-WANGXIA-2019030401", "userId": 84,
    ...
    contractnumurl = "https://home.lagou.com/crm/valueadded/product/open.json"
    data = {"templateId": 6, "num": 1, "companyId": 14, "contractNo": "LG-HD-WANGXIA-2019030401", "userId": 84,
            "startTimeStr": "2019-01-07", "endTimeStr": "2020-01-10", "upgrade": "false"}
